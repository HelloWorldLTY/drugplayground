...
ESM_PKL_PATH = "/data/zf/data/LTY-Proj/esm_emb/data_C.elegans.pkl"  # Key: protein
UNIMOL_PKL_PATH = "/data/zf/data/LTY-Proj/esm_unimol/unimol_data_C.elegans.pkl"  # Key: smile
CSV_PATH = "/data/zf/data/LTY-Proj/label/C.elegans.csv"
...
EPOCHS = 50
NUM_FOLDS = 5
RESULTS_FILE = "C.elegans_5_fold_results.txt"
...
with open(RESULTS_FILE, "w") as f:
    ...
    f.write("  1. Use smile to find embedding in unimol_data_C.elegans.pkl\n")
    f.write("  2. Use protein to find embedding in esm_emb/data_C.elegans.pkl\n")
